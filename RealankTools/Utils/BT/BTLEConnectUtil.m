...
@interface BTLEConnectUtil ()<CBCentralManagerDelegate,CBPeripheralDelegate>{
...
@implementation BTLEConnectUtil
...
-(void)centralManagerDidUpdateState:(CBCentralManager *)central{
    switch (central.state){
        ...
        case CBCentralManagerStatePoweredOff:
            ...
            if (_connectedPeripheral) {
                [self centralManager:manager didDisconnectPeripheral:_connectedPeripheral error:nil];
            }
            break;
